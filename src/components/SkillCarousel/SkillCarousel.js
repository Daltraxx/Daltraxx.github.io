...
function SkillCarousel() {
    ...
    for(let skill of skillIcons) {
        skillIconsDisplay.push(<img src={skill.src} alt={skill.description} title={skill.description} key={skill.description} />);
    };
    ...
    for(let experience of experienceIcons) {
        experienceIconsDisplay.push(<img src={experience.src} alt={experience.description} title={experience.description} key={experience.description}/>);
    };
