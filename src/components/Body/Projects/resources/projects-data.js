...
const projectsData = [
  ...
  },
  {
    ...
    description: `Just a quick description of the site you're on. While I had built many quick and minor projects before, this is one of the first applications of somewhat untrivial complexity that I'd completed and deployed. Well, untrivial back then at least. I've leveled up a lot in the time since, 
